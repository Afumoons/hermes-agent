...
TIPS = [
    ...
    "credential_pool_strategies supports fill_first, round_robin, least_used, random, and sticky_weighted rotation.",
    ...
    'credential_pool_strategies.<provider>: sticky_weighted keeps a session on one healthy key and balances new sessions by usage/weight.',
